...
trabalho AS (
  ...
  GROUP BY regiao, estado, raca_cor, trabalhou_semana_passada
  ORDER BY regiao, estado, raca_cor, trabalhou_semana_passada
)

SELECT * 
FROM trabalho
-- apenas a quem se aplica como 100%
WHERE trabalhou_semana_passada <> 'Não aplicável'